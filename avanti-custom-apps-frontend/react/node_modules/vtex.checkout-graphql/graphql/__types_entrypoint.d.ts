...
export type CustomApp = {
  ...
  id: Scalars['ID'];
  major: Scalars['Int'];
  fields: Scalars['CustomFieldsObject'];
};
...
export type Item = {
  ...
  modalType?: Maybe<Scalars['String']>;
  name?: Maybe<Scalars['String']>;
  ...
  productSpecificationGroups: Array<Maybe<ProductSpecificationGroups>>;
...
export type PriceDefinition = {
  ...
  calculatedSellingPrice: Scalars['Float'];
...
export type ProductSpecificationGroups = {
  __typename?: 'ProductSpecificationGroups';
  name?: Maybe<Scalars['String']>;
  originalName?: Maybe<Scalars['String']>;
